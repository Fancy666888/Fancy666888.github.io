...
img: assets/img/projects/mcm-voting-model.png
importance: 2
category: 研究项目
published: true
...
论文使用 34 个赛季、2777 条观测开展分析。后续整理的可复现实验中，LDWS 在已观测周重构任务上取得 0.9655 的准确率，并与排名制基线进行了统计比较。论文已被 **Axioms** 接收，卷期、页码和 DOI 将在正式上线后补充。

## 当前状态

**已被 Axioms 接收。** 参赛论文、实验代码和中间结果已经归档；正式出版信息将在期刊上线后更新。
